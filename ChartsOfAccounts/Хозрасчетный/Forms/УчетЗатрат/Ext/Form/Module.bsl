...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ВестиУчетЗатратПоПодразделениям.Доступность = НЕ БухгалтерскийУчетПереопределяемый.ВестиУчетПоПодразделениям();
	Элементы.Предупреждение.Видимость = БухгалтерскийУчетПереопределяемый.ВестиУчетПоПодразделениям();
...
Процедура УправлениеФормой(Форма)
	...
	Если (Форма.ВестиУчетЗатратПоПодразделениям <> Форма.ВестиУчетЗатратПоПодразделениямИсходноеЗначение) И Форма.ВестиУчетЗатратПоПодразделениямИсходноеЗначение = Истина Тогда

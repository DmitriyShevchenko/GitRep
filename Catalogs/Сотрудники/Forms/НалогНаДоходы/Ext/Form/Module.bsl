...
Процедура ПрочитатьСведенияОВычетахНДФЛ()
	...
	Если ЗначениеЗаполнено(ФизическоеЛицоСсылка) Тогда
		...
		Если Результат.Количество() > 0 Тогда
			...
			ИмущественныеВычетыНДФЛРасходыНаСвоеОбучение		= ВыборкаИмущВычеты.РасходыНаСвоеОбучение; 
			ИмущественныеВычетыНДФЛРасходыНаОбучениеДетей		= ВыборкаИмущВычеты.РасходыНаОбучениеДетей; 
			ИмущественныеВычетыНДФЛРасходыНаЛечение				= ВыборкаИмущВычеты.РасходыНаЛечение; 
			ИмущественныеВычетыНДФЛСтраховыеВзносыНаМедУслуги	= ВыборкаИмущВычеты.СтраховыеВзносыНаМедУслуги; 
			ИмущественныеВычетыНДФЛРасходыНаДорогостоящееЛечение= ВыборкаИмущВычеты.РасходыНаДорогостоящееЛечение; 

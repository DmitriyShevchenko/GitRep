...
Функция ПрочитатьДанныеXMLКарточки(АдресXMLФайла)
	...
	Исключение
		...
		ЭлектронныеДокументыБПВызовСервера.ОбработатьИсключениеПоЭДНаСервере(НСтр("ru = 'Чтение ЭД.'"),
...
Функция НаименованияНаДату(Контрагент, ДатаСведений) Экспорт
	...
	Если ЗначениеЗаполнено(ДатаСведений) Тогда
		...
		Если Выборка.Следующий() Тогда
			...
			НаименованияКонтрагента.НаименованиеДляПечатныхФорм = ?(ЗначениеЗаполнено(Выборка.НаименованиеПолное), Выборка.НаименованиеПолное, Выборка.Наименование);
			Возврат НаименованияКонтрагента;
		КонецЕсли;
	КонецЕсли;
	...
	НаименованияКонтрагента.НаименованиеДляПечатныхФорм = ?(ЗначениеЗаполнено(ЗначенияРеквизитов.НаименованиеПолное), ЗначенияРеквизитов.НаименованиеПолное, ЗначенияРеквизитов.Наименование);
	Возврат НаименованияКонтрагента;

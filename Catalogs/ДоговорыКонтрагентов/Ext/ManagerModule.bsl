...
Функция ЗаполнитьПризнакПредъявляетНДСДляКонтрагентовИзТС() Экспорт
	...
	Запрос.УстановитьПараметр("СтраныТС", СтраныТаможенногоСоюза);
	...
	|	Справочник.ДоговорыКонтрагентов КАК ДоговорыКонтрагентов
	|ГДЕ
	|	ДоговорыКонтрагентов.Владелец.СтранаРегистрации В(&СтраныТС)
	|	И НЕ ДоговорыКонтрагентов.ПометкаУдаления
	|	И ДоговорыКонтрагентов.ПредъявляетНДС
	...
	Пока ВыборкаДоговоров.Следующий() Цикл
		ДоговорОбъект = ВыборкаДоговоров.Ссылка.ПолучитьОбъект();
		ДоговорОбъект.ПредъявляетНДС = Ложь;
		ОбновлениеИнформационнойБазы.ЗаписатьОбъект(ДоговорОбъект);
	КонецЦикла;

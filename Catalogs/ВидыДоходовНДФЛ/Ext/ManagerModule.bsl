...
Процедура ЗаполнитьКодыДоходов2014() Экспорт 
	...
	ОписатьКодДоходаНДФЛ("Код1543", Ставка13, "1543", "Доходы по операциям, учитываемым на индивидуальном инвестиционном счете",Ложь,Ложь, ВычетыНДФЛ.Код221);
...
Процедура ЗаполнитьКодыДоходов2015() Экспорт 
	...
	ОписатьКодДоходаНДФЛ("Код1543", Ставка13, "1543", "Доходы по операциям, учитываемым на индивидуальном инвестиционном счете",Ложь,Ложь, ВычетыНДФЛ.Код221);
	ОписатьКодДоходаНДФЛ("Код2791", Ставка13, "2791", "Доходы, полученные работниками в натуральной форме в качестве оплаты труда от с/х товаропроизводителей, упл-х ЕСХН, и крестьянских х-в", Ложь, Ложь, ВычетыНДФЛ.ПустаяСсылка());

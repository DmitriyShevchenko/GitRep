...
Функция ПолучитьСтатьюДДСПоВидуОперации(ВидОперации) Экспорт
	...
	СтатьиДДС = СоответствиеСтатьейДДСОперациям(ВидОперации);
	ПредопределеннаяСтатья = СтатьиДДС[ВидОперации];
...
Функция ДанныеВыбораВидаОперацииНФО() Экспорт
	...
	ОбластьВидыОпераций = Макет.ПолучитьОбласть("Классификатор");
...
Функция СоответствиеСтатьейДДСОперациям(ВидОперации)
